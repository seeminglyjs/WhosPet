...
function chageSelect(){ 
	...
	if(selectList.options[selectList.selectedIndex].value == "F"){
		location.href = "/admin/board/list?bType=F";
	}
	if(selectList.options[selectList.selectedIndex].value == "T"){
		location.href = "/admin/board/list?bType=T";
	}
	if(selectList.options[selectList.selectedIndex].value == "R"){
		location.href = "/admin/board/list?bType=R";
	}
}
...
<form action="/admin/board/list" class="form-inline">
...
<table class="table table-bordered table-striped table-condensed">
	...
	<tr>
		...
		<td style="width: 55%"><a href="/admin/board/detail?bNo=${board.B_NO }">
