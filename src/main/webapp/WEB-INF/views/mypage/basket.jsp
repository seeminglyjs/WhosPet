		    ...
		    if ( rsp.success ) { // 결제 성공 로직
				...
				jQuery.ajax({
					...
					data: {
						...
						sNo : '${basketlist.sNo}',		//상품번호
						oName : '${basketlist.sName}',	//상품이름
						oQuantity : '${basketlist.sbQuantity}',	//주문한 수량
						oAmount : '${basketlist.sAmount}',	//상품 가격
						oTotalAmount : '${basketlist.sbAmount}', //결제할 총 가격
						oSender : '${userOrder.uName}',	//주문한 사람 이름
						oSenderPhone : '${userOrder.uPhone}', //주문한 사람 번호
						oEmail : '${userOrder.uEmail}',	//주문한 사람 이메일
						oRecipient : '${userOrder.uName}',		//받는 사람 이름
						oPostNo : '${userOrder.uPostNo}',				//우편 번호
						oAddress : '${userOrder.uAddress}',			//주소
						oDetailAddress : '${userOrder.uDetailAddress}' //상세 주소
