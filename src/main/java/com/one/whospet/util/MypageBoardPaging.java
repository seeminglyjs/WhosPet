...
public class MypageBoardPaging {
	...
	//총 게시글 수를 입력하는 생성자
	public MypageBoardPaging(int totalCount) {
	...
	public MypageBoardPaging(int totalCount, int curPage) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public MypageBoardPaging(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public MypageBoardPaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);
