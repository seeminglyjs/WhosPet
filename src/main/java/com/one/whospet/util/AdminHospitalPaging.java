...
public class AdminHospitalPaging {
	...
	//총 게시글 수를 입력하는 생성자
	public AdminHospitalPaging(int totalCount) {
	...
	public AdminHospitalPaging(int totalCount, int curPage) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public AdminHospitalPaging(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public AdminHospitalPaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);
